...
(* This is needed because sail cannot export into multiple Rocq files *)
...
Module Type Arch.
  ...
  Parameter reg_pretty : Pretty reg.
  #[export] Existing Instance reg_pretty.
  ...
  Parameter regval_transport: ∀ {rA rB : reg}, rA =@{reg} rB → reg_type rA → reg_type rB.

  (** Soundness proof for [regval_extract] *)
  Parameter regval_transport_sound: ∀ (r : reg) (e : r =@{reg} r) a, regval_transport e a = a.
